 ...
 */
public class SequentialAnimationFragment extends BaseFragment {
    ...
    protected void onViewCreated() {
        ...
        // load the animation
        anim = AnimationUtils.loadAnimation(getContext(), R.anim.sequential);
    ...
    public int getLayout() {
        return R.layout.fragment_sequential;
    }
}
