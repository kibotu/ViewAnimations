...
import net.kibotu.android.view.animations.exo.elements.AnimationElement;

import java.util.ArrayList;

public class AnimationGenerator extends AnimationElement {
    ...
    public static AnimationGenerator create() {
        return new AnimationGenerator();
    }

    @SuppressWarnings("unused")
    static AnimationGenerator create(AnimationElement initialAnimation) {
        AnimationGenerator ret = AnimationGenerator.create();
    ...
    public AnimationGenerator preDelay(double time, boolean hidden) {
        AnimationGenerator cloned = this.clone();
    ...
    @Override
    public AnimationGenerator clone() {
        AnimationGenerator ret = new AnimationGenerator();
        ret.elements = new ArrayList<AnimationElement>(elements); // the elements itself aren't cloned
